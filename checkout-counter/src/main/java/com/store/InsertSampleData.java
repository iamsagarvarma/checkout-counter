...
public class InsertSampleData implements CommandLineRunner {
	...
	public void setupBillData() {
		...
		Bill o1 = billingService.createBill(new Bill(0.0, 0, BillStatus.IN_PROGRESS));
		...
		billingService.updateBill(billUpdateInfo, billId);
		Bill retrieveUpdatedbill = billingService.getBillById(o1.getId());
